...
import { DealerPurchaseReturnInfoComponent } from './module/Dealer/forms/dealer-purchase-return-info/dealer-purchase-return-info.component';
...
import { SaleChartComponent } from './common/chart/sale-chart/sale-chart.component';
import { DistributorDashboardComponent } from './module/Distributor/forms/distributor-dashboard/distributor-dashboard.component';
import { DealerDashboardComponent } from './module/Dealer/forms/dealer-dashboard/dealer-dashboard.component';
import { PurchaseChartComponent } from './common/chart/purchase-chart/purchase-chart.component';
import { CustomerBalanceChartComponent } from './common/chart/customer-balance-chart/customer-balance-chart.component';
import { DSDLPartyBalanceChartComponent } from './common/chart/dsdlparty-balance-chart/dsdlparty-balance-chart.component';
import { SerialNoTimeLineComponent } from './common/component/serial-no-time-line/serial-no-time-line.component';
import { OldSerialNoListComponent } from './common/component/old-serial-no-list/old-serial-no-list.component';
import { ChangePasswordComponent } from './module/admin/forms/change-password/change-password.component';
import { DsdlListDetailComponent } from './module/Manufacturer/forms/manufacturer-dashboard/dsdl-list-detail/dsdl-list-detail.component';
@NgModule({
  declarations: [
    AppComponent,
    SlideInComponent,
